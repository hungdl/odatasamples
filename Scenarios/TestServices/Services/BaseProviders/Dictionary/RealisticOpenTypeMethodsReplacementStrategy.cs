...
namespace Microsoft.Test.OData.Framework.TestProviders.Dictionary
{
    ...
    public class RealisticOpenTypeMethodsReplacementStrategy : OpenTypeMethodsReplacementStrategy
    {
        ...
        /// </summary>
        /// <param name="dateTime">The value to get the day of</param>
        /// <returns>The day of the object</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1800:DoNotCastUnnecessarily", Justification = "Temporary exception for now, no time to refactor everywhere")]
        public override object Day(object dateTime)
        {
            return GetPropertyValue(dateTime, "Day");
        }
        ...
        /// </summary>
        /// <param name="dateTime">The value to get the hour of</param>
        /// <returns>The hour of the object</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1800:DoNotCastUnnecessarily", Justification = "Temporary exception for now, no time to refactor everywhere")]
        public override object Hour(object dateTime)
        {
            return GetPropertyValue(dateTime, "Hour");
        }
        ...
        /// </summary>
        /// <param name="dateTime">The value to get the minute of</param>
        /// <returns>The minute of the object</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1800:DoNotCastUnnecessarily", Justification = "Temporary exception for now, no time to refactor everywhere")]
        public override object Minute(object dateTime)
        {
            return GetPropertyValue(dateTime, "Minute");
        }
        ...
        /// </summary>
        /// <param name="dateTime">The value to get the month of</param>
        /// <returns>The month of the object</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1800:DoNotCastUnnecessarily", Justification = "Temporary exception for now, no time to refactor everywhere")]
        public override object Month(object dateTime)
        {
            return GetPropertyValue(dateTime, "Month");
        }
        ...
        /// </summary>
        /// <param name="dateTime">The value to get the second of</param>
        /// <returns>The second of the object</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1800:DoNotCastUnnecessarily", Justification = "Temporary exception for now, no time to refactor everywhere")]
        public override object Second(object dateTime)
        {
            return GetPropertyValue(dateTime, "Second");
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1800:DoNotCastUnnecessarily", Justification = "Temporary exception for now, no time to refactor everywhere")]
        public override object SubstringOf(object substring, object targetString)
        {
        ...
        /// </summary>
        /// <param name="dateTime">The value to get the year of</param>
        /// <returns>The year of the object</returns>
        public override object Year(object dateTime)
        {
            return GetPropertyValue(dateTime, "Year");
        }
